            ...
            <div className='grid grid-cols-2'>
                <div className='flex flex-col gap-4'>
                    <div className='aspect-w-1 aspect-h-1 overflow-hidden bg-secondary/50 border-2 border-accent-foreground/20 rounded-lg group'>
                        <Image src={productImage} alt="photo product" className='w-full h-full object-cover group-hover:scale-110 hoverEffect' />
                    </div>
                    <div className='w-full flex gap-4'>
                        <div className='aspect-w-1 aspect-h-1 w-24 overflow-hidden bg-secondary/50 border-2 border-accent-foreground/20 rounded-lg hover:cursor-pointer hover:border-accent-foreground/50 hoverEffect group'>
                            <Image src={productImage} alt="product image" className='w-full h-full opacity-70 group-hover:opacity-100 hoverEffect' />
                        </div>
                        <div className='aspect-w-1 aspect-h-1 w-24 overflow-hidden bg-secondary/50 border-2 border-accent-foreground/20 rounded-lg hover:cursor-pointer hover:border-accent-foreground/50 hoverEffect group'>
                            <Image src={productImage} alt="product image" className='w-full h-full opacity-70 group-hover:opacity-100 hoverEffect' />
                        </div>
