...
const ProductPage = async ({
   ...
   const product: ProductBySlug | null = await getProductBySlug(slug);
            ...
            <div className="grid grid-cols-2">
               ...
               <div className="flex flex-col px-8">
                  ...
                  <PriceView
                     ...
                     className="flex-row-reverse text-2xl justify-end gap-4"
                  />
                  ...
                  <div className="flex w-full flex-col border-2 border-secondary-foreground/30">
                     <div className="w-full flex items-center gap-4 p-4">
                        ...
                        <div>
                           ...
                           <p className="text-secondary-foreground text-sm underline">
