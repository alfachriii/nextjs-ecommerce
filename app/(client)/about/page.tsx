      ...
      <Container className="flex flex-cols gap-8 h-full items-center justify-center">
        ...
        <span className="w-2/3">
          <p className="text-center text-secondary-foreground">
            ...
            repellat aliquam pariatur illum debitis velit cupiditate tenetur
            officiis sint recusandae itaque laboriosam doloribus, a, assumenda
            eum asperiores optio possimus placeat!
          </p>
        </span>
        <AboutBanner />
